...
- `docs/` — documentação operacional, incluindo `onboarding-cliente.md`

#### Scenario: Estrutura conformante

- **WHEN** alguém abre o repositório
- **THEN** existem os diretórios `charts/`, `examples/`, `openspec/`, `.github/workflows/`, `docs/`
