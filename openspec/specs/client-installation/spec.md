# client-installation Specification

## Purpose
Definir como clientes finais instalam charts deste repositório, garantindo localização canônica única (OCI público no GHCR) e fluxo sem autenticação.
